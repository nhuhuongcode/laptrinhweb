...
if(isset($_POST['ngonngu']))
    $ngonngu1 = $_POST['ngonngu'];
    
?>
<div class="text">
        <a href="index.php">Trang chủ</a>
        <p>>></p>
        <a href="index.php?quanly=danhmucsanpham&&iddanhmuc=<?php echo $ngonngu1?>&&page=0"><?php echo $row["ten_danh_muc"]?></a>
</div>
    ...
    <?php
        ...
        $from_p = 0;
                if(isset($_POST['ngonngu']))
                    ...
                    $query = "SELECT * FROM tbl_sach INNER JOIN tbl_thong_so on tbl_sach.id_sach = tbl_thong_so.id_sach WHERE ngon_ngu ='".$iddanhmuc."' limit ".$from.",".NUM_PROD_PER_PAGE."; ";
